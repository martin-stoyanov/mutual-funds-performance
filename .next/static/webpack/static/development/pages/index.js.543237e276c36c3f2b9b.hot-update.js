...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Index, [{
    ...
    value: function render() {
      var svg = d3__WEBPACK_IMPORTED_MODULE_7__["select"]("svg#AnscombesQuartet");
      ...
      var xScale = d3__WEBPACK_IMPORTED_MODULE_7__["scaleLinear"]().domain([0, 15]).range([0, chartWidth]);
      var yScale = d3__WEBPACK_IMPORTED_MODULE_7__["scaleLinear"]().domain([0, 10]).range([chartHeight, 0]);
      var leftAxis = d3__WEBPACK_IMPORTED_MODULE_7__["axisLeft"](yScale).ticks(2).tickSize(0);
      svg.append("g").attr("class", "y axis").attr("transform", "translate(" + margin.left + "," + margin.top + ")").style("font", "8px Arial").call(leftAxis);
      var bottomAxis = d3__WEBPACK_IMPORTED_MODULE_7__["axisBottom"](xScale).ticks(3).tickSize(1);
      ...
      AnscombesQuartetData.forEach(function (d) {
        svg.append("circle").attr("r", 2.3).attr("cx", 25 + xScale(d[0])).attr("cy", 5 + yScale(d[1])).style("fill", "blue").on("click", function () {
          var circle = d3__WEBPACK_IMPORTED_MODULE_7__["select"](this);
...
//# sourceMappingURL=index.js.543237e276c36c3f2b9b.hot-update.js.map